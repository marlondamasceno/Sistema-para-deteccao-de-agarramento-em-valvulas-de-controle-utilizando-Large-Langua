#*****************
# Esta Revisão 04 da rotina de programação para detecção de stiction refina as técnicas de Engenharia de prompt
# 
# Rev.01: 
# Rev.02: 
# Rev.03: Inclusão dos delimitadores no prompt
