...
Lembre-se das TÉCNICAS PARA AVALIAÇÃO DE AGARRAMENTO EM VÁLVULAS DE CONTROLE.
    ...
    T_limite = 12 segundos. Lembre-se das TÉCNICAS PARA AVALIAÇÃO DE AGARRAMENTO EM VÁLVULAS DE CONTROLE.
    ...
    Considerar T_limite = 12 segundos. Lembre-se das TÉCNICAS PARA AVALIAÇÃO DE AGARRAMENTO EM VÁLVULAS DE CONTROLE.
