...
# Rev.04: 
# Rev.05: 
# Rev.06: Inserção de delimitadores no prompt e reescrita de tópicos ao final de cada ordem
# Rev.07: Inserção da variável T_limite no prompt
# Rev.08: Inserção de um exemplo similar ao sinal de amostra
#
...
Oscilação: é quando ocorre um valor de erro entre o SP e a PV sem alteração do SP, seguido de uma ação na MV para que seja ajustada a PV,
mas ocorre a oscilação do valor da PV, com o valor do erro somentepassando pelo valor de zero em um pequeno instante de tempo, sem ocorrer
estabilidade no sistema de controle no trecho. A estabilidade do sistema é definida como N instantes de tempo após o tempo final tf da oscilação.
...
--- Critério de Tempo de reação da MV TrMV e de Tempo de reação da PV ---
...
T_limite: limite de tempo de reação da PV em relação à MV
...
Caso o tempo de reação da PV seja maior que o T_limite de tempo de reação da MV, é considerado que há presença de agarramento no transiente.
O tempo de reação aceitável da PV deve ser menor ou igual ao T_limite em relação ao tempo de reação da MV para que não seja considerado agarramento.

(TrPV) <= (T_limite) = True, então não há evidência de agarramento no distúrbio transiente.
(TrPV) <= (T_limite) = False, então há evidência de agarramento no distúrbio transiente.

Caso não seja especificado o valor de T_limite, utilizar o valor de [T_limite = ((1.5/Tam)*TrMV)]. Logo:
...
- Transientes possuem um número de zero-crossings menor que 2.
- Tempo de reação da PV (TrPV) maior ou igual a T_limite especificado.
...
Como não foi especificado o valor de T_limite, é considerado então T_limite = ((1.5/Tam)*TrMV).
...
entre a reação do sinal de MV e a reação do sinal da PV sem a ocorrência de uma alteração no valor do SP, ou seja, quando ocorre um
distúrbio do tipo distúrbio isolado, é gerado um valor de erro significativo no sistema maior que o critério C determinado sem
ocorrer mudança no Set Point (SP), e ocorre também um grande atraso no tempo de reação da PV em relação ao tempo de reação da MV,
então esta situação é classificada como agarramento em um distúrbio isolado.

Caso o tempo de reação da PV seja maior que o T_limite de tempo de reação da MV, é considerado que há presença de agarramento no distúrbio isolado.
O tempo de reação aceitável da PV deve ser menor ou igual ao T_limite em relação ao tempo de reação da MV para que não seja considerado agarramento.
...
- Obrigatoriamente não deve existir alteração do SP em instantes próximos ao instante inicial ti do distúrbio. Caso exista alteração do SP em instantes
próximos ao instante inicial ti do distúrbio, não é um distúrbio isolado.
- Distúrbios isolados possuem um número de zero-crossings menor que 2.
- Tempo de reação da PV (TrPV) maior ou igual a T_limite especificado.
...
--- Agarramento em Oscilações ---

O agarramento pode apresentar comportamentos específicos durante uma oscilação, como a defasagem total ou parcial
entre a reação do sinal de MV e a reação do sinal da PV durante os ciclos da oscilação sem a ocorrência de uma alteração no valor do SP,
seguido de uma ação na MV para que seja ajustada a PV, mas não ocorre reação no sentido do valor da PV, com o valor do erro sendo incrementado mesmo após
a alteração do valor da MV em sentido oposto ao erro. A reação atrasada/defasada da PV pode ocorrer, com o valor do erro somente passando pelo
valor de zero em um pequeno instante de tempo, sem ocorrer estabilidade no sistema de controle no trecho, ou seja, quando ocorre um distúrbio do tipo oscilação,
é gerado um valor de erro significativo no sistema maior que o critério C determinado sem ocorrer mudança no Set Point (SP), e ocorre também um grande atraso
no tempo de reação da PV em relação ao tempo de reação da MV, com número de zero-crossings superior a 2 contagens, então esta situação é classificada como agarramento em uma oscilação.

Caso o tempo de reação da PV seja maior que o T_limite de tempo de reação da MV, é considerado que há presença de agarramento na oscilação.
O tempo de reação aceitável da PV deve ser menor ou igual ao T_limite em relação ao tempo de reação da MV para que não seja considerado agarramento.
...
Para identificar se ocorreu um agarramento em um trecho de distúrbio tipo oscilação, observar os seguintes aspectos:

- Obrigatoriamente não deve existir alteração do SP em instantes próximos ao instante inicial ti do distúrbio. Caso exista alteração do SP em instantes
próximos ao instante inicial ti do distúrbio, não é um distúrbio tipo oscilação.
- Distúrbios tipo oscilação possuem um número de zero-crossings maior do que 2.
- Tempo de reação da PV (TrPV) maior ou igual a T_limite especificado. Caso o Tempo de reação da PV seja menor que T_limite especificado
o distúrbio tipo oscilação não foi causado por agarramento.

--- Exemplo 1 de comportamento específico de agarramento em um distúrbio tipo oscilação ---

Utilizar o critério C2%. Considere T_limite = 8 segundos.
...
t10: SP = 20.0, PV = 19.7, MV = 35.6, t = 55.0s
t11: SP = 20.0, PV = 19.9, MV = 35.7, t = 55.5s
t12: SP = 20.0, PV = 20.2, MV = 84.6, t = 56.0s
t13: SP = 20.0, PV = 21.6, MV = 84.0, t = 56.5s
t14: SP = 20.0, PV = 22.7, MV = 84.0, t = 57.0s
t15: SP = 20.0, PV = 23.8, MV = 84.0, t = 57.5s
t16: SP = 20.0, PV = 24.9, MV = 84.0, t = 58.0s
t17: SP = 20.0, PV = 26.0, MV = 71.8, t = 58.5s
t18: SP = 20.0, PV = 27.1, MV = 71.8, t = 59.0s
t19: SP = 20.0, PV = 26.0, MV = 71.8, t = 59.5s
t20: SP = 20.0, PV = 24.9, MV = 71.8, t = 60.0s
t21: SP = 20.0, PV = 23.8, MV = 59.6, t = 60.5s
t22: SP = 20.0, PV = 22.7, MV = 59.6, t = 61.0s
t23: SP = 20.0, PV = 21.6, MV = 59.6, t = 61.5s
t24: SP = 20.0, PV = 20.3, MV = 59.6, t = 62.0s
t25: SP = 20.0, PV = 19.8, MV = 58.8, t = 62.5s
t26: SP = 20.0, PV = 19.7, MV = 58.8, t = 63.0s
t27: SP = 20.0, PV = 18.6, MV = 58.8, t = 63.5s
t28: SP = 20.0, PV = 17.4, MV = 58.8, t = 64.0s
t29: SP = 20.0, PV = 16.1, MV = 65.3, t = 64.5s
t30: SP = 20.0, PV = 15.0, MV = 65.3, t = 65.0s
t31: SP = 20.0, PV = 13.9, MV = 65.3, t = 65.5s
t32: SP = 20.0, PV = 12.8, MV = 65.3, t = 66.0s
t33: SP = 20.0, PV = 12.2, MV = 83.3, t = 66.5s
t34: SP = 20.0, PV = 11.1, MV = 83.3, t = 67.0s
t35: SP = 20.0, PV = 10.1, MV = 83.3, t = 67.5s
t36: SP = 20.0, PV = 09.4, MV = 83.3, t = 68.0s
t37: SP = 20.0, PV = 09.0, MV = 89.8, t = 68.5s
t38: SP = 20.0, PV = 08.2, MV = 89.8, t = 69.0s
t39: SP = 20.0, PV = 07.4, MV = 89.8, t = 69.5s
t40: SP = 20.0, PV = 06.7, MV = 96.3, t = 70.0s
t41: SP = 20.0, PV = 06.5, MV = 96.3, t = 70.5s
t42: SP = 20.0, PV = 06.0, MV = 96.3, t = 71.0s
t43: SP = 20.0, PV = 05.7, MV = 96.3, t = 71.5s
t44: SP = 20.0, PV = 05.7, MV = 96.3, t = 72.0s
t45: SP = 20.0, PV = 05.5, MV = 100.0, t = 72.5s
t46: SP = 20.0, PV = 05.1, MV = 100.0, t = 73.0s
t47: SP = 20.0, PV = 05.1, MV = 100.0, t = 73.5s
t48: SP = 20.0, PV = 05.1, MV = 100.0, t = 74.0s
t49: SP = 20.0, PV = 05.1, MV = 100.0, t = 74.5s
t50: SP = 20.0, PV = 05.1, MV = 100.0, t = 75.0s
t51: SP = 20.0, PV = 05.1, MV = 100.0, t = 75.5s
t52: SP = 20.0, PV = 05.1, MV = 100.0, t = 76.0s
t53: SP = 20.0, PV = 12.5, MV = 100.0, t = 76.5s
t54: SP = 20.0, PV = 16.4, MV = 100.0, t = 77.0s
t55: SP = 20.0, PV = 18.6, MV = 100.0, t = 77.5s
t56: SP = 20.0, PV = 19.7, MV = 100.0, t = 78.0s 
t57: SP = 20.0, PV = 20.2, MV = 84.6, t = 78.5s
t58: SP = 20.0, PV = 21.6, MV = 84.0, t = 79.0s
t59: SP = 20.0, PV = 22.7, MV = 84.0, t = 79.5s
t60: SP = 20.0, PV = 23.8, MV = 84.0, t = 80.0s
...
t10: |erro| = |SP - PV| = |20.0 - 19.7| = | 0.30| = 0.30, (|erro|)>(2% do SP) = (0.30)>(0.4) = False
t11: |erro| = |SP - PV| = |20.0 - 19.9| = | 0.10| = 0.10, (|erro|)>(2% do SP) = (0.10)>(0.4) = False
t12: |erro| = |SP - PV| = |20.0 - 20.2| = |-0.20| = 0.20, (|erro|)>(2% do SP) = (0.20)>(0.4) = False
t13: |erro| = |SP - PV| = |20.0 - 21.6| = |-1.60| = 1.60, (|erro|)>(2% do SP) = (1.60)>(0.4) = True
t14: |erro| = |SP - PV| = |20.0 - 22.7| = |-2.70| = 2.70, (|erro|)>(2% do SP) = (2.70)>(0.4) = True
t15: |erro| = |SP - PV| = |20.0 - 23.8| = |-3.80| = 3.80, (|erro|)>(2% do SP) = (3.80)>(0.4) = True
t16: |erro| = |SP - PV| = |20.0 - 24.9| = |-4.90| = 4.90, (|erro|)>(2% do SP) = (4.90)>(0.4) = True
t17: |erro| = |SP - PV| = |20.0 - 26.0| = |-6.00| = 6.00, (|erro|)>(2% do SP) = (6.00)>(0.4) = True
t18: |erro| = |SP - PV| = |20.0 - 27.1| = |-7.10| = 7.10, (|erro|)>(2% do SP) = (7.10)>(0.4) = True
t19: |erro| = |SP - PV| = |20.0 - 26.0| = |-6.00| = 6.00, (|erro|)>(2% do SP) = (6.00)>(0.4) = True
t20: |erro| = |SP - PV| = |20.0 - 24.9| = |-4.90| = 4.90, (|erro|)>(2% do SP) = (4.90)>(0.4) = True
t21: |erro| = |SP - PV| = |20.0 - 23.8| = |-3.80| = 3.80, (|erro|)>(2% do SP) = (3.80)>(0.4) = True
t22: |erro| = |SP - PV| = |20.0 - 22.7| = |-2.70| = 2.70, (|erro|)>(2% do SP) = (2.70)>(0.4) = True
t23: |erro| = |SP - PV| = |20.0 - 21.6| = |-1.60| = 1.60, (|erro|)>(2% do SP) = (1.60)>(0.4) = True
t24: |erro| = |SP - PV| = |20.0 - 20.3| = |-0.30| = 0.30, (|erro|)>(2% do SP) = (0.30)>(0.4) = False
t25: |erro| = |SP - PV| = |20.0 - 19.8| = | 0.20| = 0.20, (|erro|)>(2% do SP) = (0.20)>(0.4) = False
t26: |erro| = |SP - PV| = |20.0 - 19.7| = | 0.30| = 0.30, (|erro|)>(2% do SP) = (0.30)>(0.4) = False
t27: |erro| = |SP - PV| = |20.0 - 18.6| = | 1.40| = 1.40, (|erro|)>(2% do SP) = (1.40)>(0.4) = True
t28: |erro| = |SP - PV| = |20.0 - 17.4| = | 2.60| = 2.60, (|erro|)>(2% do SP) = (2.60)>(0.4) = True
t29: |erro| = |SP - PV| = |20.0 - 16.1| = | 3.90| = 3.90, (|erro|)>(2% do SP) = (3.90)>(0.4) = True
t30: |erro| = |SP - PV| = |20.0 - 15.0| = | 5.00| = 5.00, (|erro|)>(2% do SP) = (5.00)>(0.4) = True
t31: |erro| = |SP - PV| = |20.0 - 13.9| = | 6.10| = 6.10, (|erro|)>(2% do SP) = (6.10)>(0.4) = True
t32: |erro| = |SP - PV| = |20.0 - 12.8| = | 7.20| = 7.20, (|erro|)>(2% do SP) = (7.20)>(0.4) = True
t33: |erro| = |SP - PV| = |20.0 - 12.2| = | 7.80| = 7.80, (|erro|)>(2% do SP) = (7.80)>(0.4) = True
t34: |erro| = |SP - PV| = |20.0 - 11.1| = | 8.90| = 8.90, (|erro|)>(2% do SP) = (8.90)>(0.4) = True
t35: |erro| = |SP - PV| = |20.0 - 10.1| = | 9.90| = 9.90, (|erro|)>(2% do SP) = (9.90)>(0.4) = True
t36: |erro| = |SP - PV| = |20.0 - 09.4| = | 10.60| = 10.60, (|erro|)>(2% do SP) = (10.60)>(0.4) = True
t37: |erro| = |SP - PV| = |20.0 - 09.0| = | 11.00| = 11.00, (|erro|)>(2% do SP) = (11.00)>(0.4) = True
t38: |erro| = |SP - PV| = |20.0 - 08.2| = | 11.80| = 11.80, (|erro|)>(2% do SP) = (11.80)>(0.4) = True
t39: |erro| = |SP - PV| = |20.0 - 07.4| = | 12.60| = 12.60, (|erro|)>(2% do SP) = (12.60)>(0.4) = True
t40: |erro| = |SP - PV| = |20.0 - 06.7| = | 13.30| = 13.30, (|erro|)>(2% do SP) = (13.30)>(0.4) = True
t41: |erro| = |SP - PV| = |20.0 - 06.5| = | 13.50| = 13.50, (|erro|)>(2% do SP) = (13.50)>(0.4) = True
t42: |erro| = |SP - PV| = |20.0 - 06.0| = | 14.00| = 14.00, (|erro|)>(2% do SP) = (14.00)>(0.4) = True
t43: |erro| = |SP - PV| = |20.0 - 05.7| = | 14.30| = 14.30, (|erro|)>(2% do SP) = (14.30)>(0.4) = True
t44: |erro| = |SP - PV| = |20.0 - 05.7| = | 14.30| = 14.30, (|erro|)>(2% do SP) = (14.30)>(0.4) = True
t45: |erro| = |SP - PV| = |20.0 - 05.5| = | 14.50| = 14.50, (|erro|)>(2% do SP) = (14.50)>(0.4) = True
t46: |erro| = |SP - PV| = |20.0 - 05.1| = | 14.90| = 14.90, (|erro|)>(2% do SP) = (14.90)>(0.4) = True
t47: |erro| = |SP - PV| = |20.0 - 05.1| = | 14.90| = 14.90, (|erro|)>(2% do SP) = (14.90)>(0.4) = True
t48: |erro| = |SP - PV| = |20.0 - 05.1| = | 14.90| = 14.90, (|erro|)>(2% do SP) = (14.90)>(0.4) = True
t49: |erro| = |SP - PV| = |20.0 - 05.1| = | 14.90| = 14.90, (|erro|)>(2% do SP) = (14.90)>(0.4) = True
t50: |erro| = |SP - PV| = |20.0 - 05.1| = | 14.90| = 14.90, (|erro|)>(2% do SP) = (14.90)>(0.4) = True
t51: |erro| = |SP - PV| = |20.0 - 05.1| = | 14.90| = 14.90, (|erro|)>(2% do SP) = (14.90)>(0.4) = True
t52: |erro| = |SP - PV| = |20.0 - 05.1| = | 14.90| = 14.90, (|erro|)>(2% do SP) = (14.90)>(0.4) = True
t53: |erro| = |SP - PV| = |20.0 - 12.5| = | 7.50| = 7.50, (|erro|)>(2% do SP) = (7.50)>(0.4) = True
t54: |erro| = |SP - PV| = |20.0 - 16.4| = | 3.60| = 3.60, (|erro|)>(2% do SP) = (2.60)>(0.4) = True
t55: |erro| = |SP - PV| = |20.0 - 18.6| = | 1.40| = 1.40, (|erro|)>(2% do SP) = (1.40)>(0.4) = True
t56: |erro| = |SP - PV| = |20.0 - 19.7| = | 0.30| = 0.30, (|erro|)>(2% do SP) = (0.30)>(0.4) = False
t57: |erro| = |SP - PV| = |20.0 - 20.2| = |-0.20| = 0.20, (|erro|)>(2% do SP) = (0.20)>(0.4) = False
t58: |erro| = |SP - PV| = |20.0 - 21.6| = |-1.60| = 1.60, (|erro|)>(2% do SP) = (1.60)>(0.4) = True
...
Foi identificados 01 distúrbios.

O instante inicial do distúrbio é em ti1=56.5s, pois é o primeiro instante de tempo em que o |erro| foi maior que 2% do valor do SP.
O instante final do distúrbio é em tf1=109.0s, pois é o primeiro instante de tempo após ti em que o |erro| foi menor que 2% do valor do SP E
os N = 20 instantes de tempo seguintes possuem valores de |erro| menores do que 2%.

O distúrbio 01 ocorre do instante ti1=56.0s a tf1=109.0s.

Com o intervalo do distúrbio devidamente identificado, realiza-se a classificação do distúrbio:

O distúrbio ocorre do instante ti1=56.0s a tf1=109.0s, é um distúrbio tipo oscilação pois ocorre um valor de erro entre o SP e a PV sem alteração do SP,
ocorrem 06 zero-crossings nos intervalos zc1 de 62.0s a 63.0s, zc2 de 78.0s a 78.5s, zc3 de 84.5s a 85.5s, zc4 de 91.5s a 92.0s, zc5 de 98.0s a 99.0s e zc6 de 105.0s a 105.5s,
o que permite concluir que é um distúrbio tipo oscilação que ocorre do instante ti1=56.0s a tf1=109.0s e possui 06 zero crossings.

O valor para T_limite especificado é de T_limite=8 segundos.

Dentro da oscilação, há um intervalo de agarramento, do instante 64.5 a 76.5, pois, o sinal da MV é crescente e o sinal da PV decresce mesmo com a MV em 100% de seu valor.
A PV reage somente após 12 segundo depois a primeira ação da MV, onde o TrPV=12 segundos, sendo TrPV>T_limite. A PV reage somente no instante 76.5, 12 segundos
após a atuação da MV no instante 64.5s. Os demais instantes do distúrbio são oscilações que não são causadas por agarramento , e o tempo de reação da PV são menores do que o T_limite especificado.

Conclusão: foi detectado um distúrbio tipo oscilação do instante 56.0s ao instante 109.s, onde há evidência de agarramento no instante 64.5 a 76.5.

--- Fim do Exemplo 1 de comportamento específico de agarramento em um distúrbio tipo oscilação ---
...
Lembre-se das TÉCNICAS PARA AVALIAÇÃO DE AGARRAMENTO EM VÁLVULAS DE CONTROLE.
    ...
    a. **Verificar agarramento nos distúrbios classificados como transientes:** Verifique se há indícios de agarramento nos trechos de distúrbio classificados como transientes. Considerar
    T_limite = 6 segundos. Lembre-se das TÉCNICAS PARA AVALIAÇÃO DE AGARRAMENTO EM VÁLVULAS DE CONTROLE.
    ...
    Considerar T_limite = 6 segundos. Lembre-se das TÉCNICAS PARA AVALIAÇÃO DE AGARRAMENTO EM VÁLVULAS DE CONTROLE.
