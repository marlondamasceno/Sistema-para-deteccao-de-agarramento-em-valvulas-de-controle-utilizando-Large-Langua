#*****************
# Esta Revisão 03 da rotina de programação para detecção de stiction refina as técnicas de Engenharia de prompt
#
# Inclusão dos delimitadores no prompt
#
...
nas formas de onda da PV e na MV.
...
um trecho como OSCILAÇÃO (limit cycle).
...
agarramento na válvula de controle.
...
data/..." no texto. Use apenas frases e quebras de linha simples.
