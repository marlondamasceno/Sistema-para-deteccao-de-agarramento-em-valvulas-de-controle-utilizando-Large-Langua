...
# Rev.09: Rev.07 acrescida da solicitação de apresentar os valores de TrPV e TrMV
#
#
...
Lembre-se das TÉCNICAS PARA AVALIAÇÃO DE AGARRAMENTO EM VÁLVULAS DE CONTROLE.
    ...
    T_limite = 12 segundos. Informar o TrPV e TrMV de cada distúrbio. Lembre-se das TÉCNICAS PARA AVALIAÇÃO DE AGARRAMENTO EM VÁLVULAS DE CONTROLE.
